...
set_clock_groups -name async_clk100_clk12 -asynchronous -group [get_clocks -include_generated_clocks clk100_mmcm] -group [get_clocks -include_generated_clocks clk12_mmcm]
...
##Pmod Header JE
##IO_L4P_T0_34
set_property PACKAGE_PIN V12 [get_ports nes_joypad_data1]
set_property IOSTANDARD LVCMOS33 [get_ports nes_joypad_data1]

##IO_L18N_T2_34
set_property PACKAGE_PIN W16 [get_ports nes_joypad_data2]
set_property IOSTANDARD LVCMOS33 [get_ports nes_joypad_data2]

##IO_25_35
set_property PACKAGE_PIN J15 [get_ports nes_joypad_clk]
set_property IOSTANDARD LVCMOS33 [get_ports nes_joypad_clk]

##IO_L19P_T3_35
set_property PACKAGE_PIN H15 [get_ports nes_joypad_latch]
